...
class EventsController {
  ...
  public getEventById = async (
    ...
    try {
      ...
      const findOneEventData: Event = await this.eventService.findEventById(
        eventId
      );
  ...
  public createEvent = async (
    ...
    try {
      ...
      const createEventData: Event = await this.eventService.createEvent(
        eventData
      );
  ...
  public updateEvent = async (
    ...
    try {
      ...
      const updateEventData: Event = await this.eventService.updateEvent(
        eventId,
        eventData
      );
  ...
  public deleteEvent = async (
    ...
    try {
      const eventId = Number(req.params.id);
      const deleteEventData: Event = await this.eventService.deleteEvent(
        eventId
      );
